...
tmux send-keys "optirun roslaunch strands_morse uol_mht_morse.launch"

tmux select-window -t $SESSION:3
tmux send-keys "roslaunch strands_uol_sim mht_nav.launch"

tmux select-window -t $SESSION:4
tmux send-keys "optirun rosrun rviz rviz"
